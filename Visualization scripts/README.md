...
- **Output:** PNG release profile plots for entire lattice, friendly layer, blind layer and % released
...
- Generates spatial snapshots of ant positions on 200×200 lattice

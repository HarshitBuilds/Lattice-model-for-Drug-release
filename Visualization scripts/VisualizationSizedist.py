...
def plot_size_distribution(sizedist, filename):
    ...
    plt.rcParams.update({
        'font.family': 'Arial',
        'font.size': 10,  # Increased from 10
        'axes.titlesize': 12,  # Increased from 12
        'axes.labelsize': 11,  # Increased from 11        '
        'xtick.labelsize': 7.5,  # Increased from 10
        'ytick.labelsize': 8,  # Increased from 10
        'legend.fontsize': 9,  # Increased from 9
        'figure.dpi': 300
    })
...
def main():
    ...
    filename = "Sizedistribution(w1=0.1).txt"
